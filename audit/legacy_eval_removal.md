...
`outputs/tr/diffusiondb/_invalid/legacy_20260718T072817Z/`; see its `DO_NOT_USE.md`. Clean/watermarked
...
- Historical unaligned formal output
  `outputs/tr/diffusiondb/formal_eval/1001_20260718T090947Z` is retained
