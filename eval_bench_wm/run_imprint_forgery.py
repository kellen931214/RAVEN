...
from utils.bit_accuracy import format_bit_accuracy_rows, format_bit_accuracy_value
...
print(
    ...
    f"bit accuracy: {bit_accuracy_display(results)}, "
...
for step in tqdm.tqdm(range(args.steps)):
    ...
    if step % args.validation_steps == 0:
        ...
        df = pd.DataFrame(format_bit_accuracy_rows(rows))
